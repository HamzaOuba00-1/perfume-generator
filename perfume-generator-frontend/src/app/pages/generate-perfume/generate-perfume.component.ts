...
import { OilSelectorComponent } from '../../components/oil-selector/oil-selector.component';
import { ExplainSystemComponent } from '../../components/explain-system/explain-system.component';
import { GenerationConditionsModalComponent } from '../../components/generation-conditions-modal/generation-conditions-modal.component';
...
export class GeneratePerfumeComponent implements OnInit {
  ...
  generatePerfume(): void {
    ...
    // ✅ Toutes les conditions sont OK → génération
